    ...
    <div class="row px-3">
      <div class="col-lg-7 col-xl-5 card flex-row mx-auto px-0">
        ...
        <div class="card-body">
          ...
          <form class="form-box px-3" method="post" action="<?php echo e(route('forget.email')); ?>">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\prabe\OneDrive\Desktop\AutoMotive\resources\views/admin/forgetpassword/forgetemail.blade.php ENDPATH**/ ?>