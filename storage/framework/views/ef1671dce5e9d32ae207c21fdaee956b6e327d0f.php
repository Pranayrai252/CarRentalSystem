...
<body>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer" style=" display: flex; justify-content: center; align-items: center;">
          ...
          <button class="ml-3 rounded" style="background-color:#f94449; padding:3px 10px;">
            <a href="/cancel-booking/<?php echo e($b->id); ?>" type="button" class="text-white">Yes</a>
          </button>
  ...
  <div class="modal fade" id="exampleModal-<?php echo e($b->vehicle->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="margin-top:80px;">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/vehicle-rating/<?php echo e($b->vehicle->id); ?>" method="post">
          <?php echo csrf_field(); ?>
          <div class="modal-body" style="background: #fff; border-radius:20px;">
            <div class="rate py-3 text-white mt-3">
              <div class="rating"> <input type="radio" name="rating" value="5" id="<?php echo e($b->vehicle->id); ?>5"><label for="<?php echo e($b->vehicle->id); ?>5">☆</label> <input type="radio" name="rating" value="4" id="<?php echo e($b->vehicle->id); ?>4"><label for="<?php echo e($b->vehicle->id); ?>4">☆</label> <input type="radio" name="rating" value="3" id="<?php echo e($b->vehicle->id); ?>3"><label for="<?php echo e($b->vehicle->id); ?>3">☆</label> <input type="radio" name="rating" value="2" id="<?php echo e($b->vehicle->id); ?>2"><label for="<?php echo e($b->vehicle->id); ?>2">☆</label> <input type="radio" name="rating" value="1" id="<?php echo e($b->vehicle->id); ?>1"><label for="<?php echo e($b->vehicle->id); ?>1">☆</label>
              </div>
  ...
  <section class="section featured-car" id="featured-car">
    <div class="container" style="margin-top: 50px;">
      ...
      <ul class="featured-car-list">
        <?php $__currentLoopData = $booking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($b->status == 'active' || $b->status == 'pending'): ?>
        <li class="filtercar">
          <div class="featured-car-card shadow">

            <figure class="card-banner">
              <img src="<?php echo e($b->vehicle['image']); ?>" alt="carname" loading="lazy" width="440" height="300" class="w-100">
            </figure>
            ...
            <div class="card-content">
              ...
              <div class="card-title-wrapper">
                <h3 class="h3 card-title">
                  <a href="#" style="text-decoration: none;"><?php echo e($b->vehicle['name']); ?></a>
                </h3>
              ...
              <ul class="card-list">
                ...
                <li class="card-list-item">
                  ...
                  <span class="card-item-text"><?php echo e($b->vehicle->user['name']); ?></span>
                </li>
                ...
                <li class="card-list-item">
                  ...
                  <span class="card-item-text"><?php echo e($b->from_date); ?></span>
                </li>
              ...
              <div class="card-price-wrapper">
                ...
                <p class="card-price">
                  <strong>Rs. <?php echo e($b->total_price); ?></strong>
                </p>

                <!-- <button class="btn fav-btn" aria-label="Add to favourite list">
                                <ion-icon name="heart-outline"></ion-icon>
                            </button> -->
                <button type="button" class="btn fav-btn" data-toggle="modal" data-target="#exampleModal-<?php echo e($b->vehicle->id); ?>" aria-label="Add to favourite list">
                  <ion-icon name="star-outline"></ion-icon>
                </button>
                <?php if($b->payment=='paid' || $b->payment=='cash in hand'): ?>
                <?php else: ?>
                <button class="no-focus" data-toggle="modal" data-target="#decline-<?php echo e($b->id); ?>">
                  <ion-icon name="trash-outline" style="font-size: 25px; color:#f94449;"></ion-icon>
                </button>
                <?php endif; ?>
                <?php if($b->status=='active' && $b->payment=='unpaid'): ?>
                <a href="/booking-payment/<?php echo e($b->id); ?>" type="button">
                  <button class="btn">
                    Pay Now
                  </button>
                </a>
...
</html><?php /**PATH C:\Users\Nishan\Desktop\Automotive\AutoMotive\resources\views/frontend/user/checkout/index.blade.php ENDPATH**/ ?>