    ...
    <div class="row px-3">
      <div class="col-lg-7 col-xl-5 card flex-row mx-auto px-0">
        ...
        <div class="card-body">
          ...
          <form class="form-box px-3" method="post" action="<?php echo e(route('forget.otp')); ?>">
            <?php echo csrf_field(); ?>
            <div class="form-input" style="display: none;">
              <span><i class="fa-solid fa-envelope"></i></i></span>
              <input type="email" name="email" value="<?php echo e(session('email') ?? ''); ?>" placeholder="Email Address" tabindex="10" required>
            </div>
...
</html><?php /**PATH C:\Users\prabe\OneDrive\Desktop\AutoMotive\resources\views/admin/forgetpassword/forgetotp.blade.php ENDPATH**/ ?>