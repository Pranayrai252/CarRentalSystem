          ...
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="update-settings" action="<?php echo e(route('avatar.update')); ?>" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="app-modal-body">
                      ...
                      style="background-image: url('<?php echo e(Chatify::getUserWithAvatar(Auth::user())->avatar); ?>'); width:20px; height:20px;"
                      ></div>
...
<?php /**PATH C:\Users\Nishan\Desktop\Automotive\AutoMotive\resources\views/vendor/Chatify/layouts/modals.blade.php ENDPATH**/ ?>