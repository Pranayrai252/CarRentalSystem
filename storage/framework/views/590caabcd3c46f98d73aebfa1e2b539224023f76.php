      ...
      <div class="container">
        ...
        <form action="" class="hero-form">
          ...
          <div class="input-wrapper">
            <label for="input-1" class="input-label">vehicle, category or brand</label>

            <input type="text" name="car-model" id="input-1" class="input-field" placeholder="Looking for vehicle?">
          </div>

          <div class="input-wrapper">
            <label for="input-2" class="input-label">From Date:</label>

            <input type="Date" name="from_date" id="input-2" class="input-field">
          </div>

          <div class="input-wrapper">
            <label for="input-3" class="input-label">To Date:</label>

            <input type="Date" name="to_date" id="input-3" class="input-field">
          </div>
...
<?php echo $__env->make('frontend.user.mainuser', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Nishan\Desktop\Automotive\AutoMotive\resources\views/frontend/user/userpage.blade.php ENDPATH**/ ?>