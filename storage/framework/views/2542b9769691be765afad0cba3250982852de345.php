...
<body>
  ...
  <div class="modal fade" id="comment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="margin-top:50px; height:500px;">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <?php if($r->feedback): ?>
        <div class="modal-body">
          <?php if($r->user->profile==null): ?>
          <div style="width:100%;">
            <div style="display:flex; justify-content:start; align-items:center;">
              <img src="/user_image/user.jpg" alt="profile" style="width: 40px; height:40px; border-radius:20px;">
              <span class="ml-3"><?php echo e($r->user->name); ?></span>
            </div>
            <span style="margin-left: 58px;"><?php echo e($r->feedback); ?></span>
            <hr>
          </div>
          <?php else: ?>
          <div style="width:100%; margin-top:0px;">
            <div style="display:flex; justify-content:start; align-items:center;">
              <img src="<?php echo e($r->user->profile); ?>" alt="profile" style="width: 40px; height:40px; border-radius:20px;">
              <span class="ml-3"><?php echo e($r->user->name); ?></span>
            </div>
            <span style="margin-left: 58px;"><?php echo e($r->feedback); ?></span>
            <hr>
  ...
  <form action="/create-booking/<?php echo e($vehicle->id); ?>" method="post">
    <?php echo csrf_field(); ?>
    <section class="text-gray-600 body-font overflow-hidden">
      <div class="container mb-5 py-10 bg-white shadow" style="border-radius: 10px; width:70%; margin-top:70px;">
        <div class="lg:w-4/5  flex flex-wrap mx-auto" style=" width:90%;">
          <img alt="vehicle" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="<?php echo e($vehicle->image); ?>">
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 class="text-sm title-font text-gray-500 tracking-widest"><?php echo e($vehicle->brand); ?></h2>
            <h1 class="text-gray-900 text-3xl title-font font-medium mb-1"><?php echo e($vehicle->name); ?></h1> 

              <div  style="display:flex; justify-content:start; align-items:center;">
                <p class="leading-relaxed mr-2" style="font-size: 18px; font-weight:500;">Owner: <?php echo e($vehicle->user['name']); ?></p>
                <span class="mr-2">|</span>
                <span style="padding: 3px 8px; border-radius: 10px;background-color:gray; color: #fff; display:flex; justify-content:center; align-items:center; "><?php echo e($vehicle->driver_stat); ?></span>
              </div>
          ...
          <p class="leading-relaxed"><?php echo e($vehicle->description); ?></p>
          <p class="leading-relaxed">Engine Type: <?php echo e($vehicle->engine); ?> / Fuel: <?php echo e($vehicle->fuel); ?> / <?php echo e($vehicle->seat_capacity); ?> seats</p>
          ...
          <hr class="mt-4 mb-4">
          <div class="flex">
            <span class="title-font font-medium text-2xl mr-4 text-gray-900">Rs. <?php echo e($vehicle->price); ?>/day</span>
...
</html><?php /**PATH C:\Users\Nishan\Desktop\Automotive\AutoMotive\resources\views/frontend/user/vehicle/vehicledetail.blade.php ENDPATH**/ ?>