...
<body>
    ...
    <div style="position: fixed; top:10rem;" class="modal" tabindex="-1" id="pay-<?php echo e($booking->id); ?>">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer" style=" display: flex; justify-content: center; align-items: center;">
          ...
          <button class="ml-3 rounded" style="background-color:#f94449; padding:3px 10px;">
            <a href="<?php echo e(route('verify-cash', ['id' => $booking->id])); ?>" type="button" class="text-white">Yes</a>
          </button>
        ...
        <div class="container">
            ...
            <div class="header-actions">
                ...
                <div class="header-contact">
                    <a href="tel:9819370064" class="contact-link">+977 9803564734</a>
                ...
                <div class="dropdown show">
                    <a href="#" class="btn user-btn dropdown-toggle" aria-label="Profile" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="width:35px; height:35px; position:relative; border-radius:20px;">
                        ...
                        <?php else: ?>
                        <img src="<?php echo e($user->profile); ?>" alt="profile" style="width: 40px; height:40px; position:absolute; border-radius:20px;">
                        <?php endif; ?>
                    </a>
    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container mb-5 mt-4 py-10 bg-white shadow" style="border-radius: 10px; width:70%;">
            <div class="lg:w-4/5  flex flex-wrap mx-auto" style=" width:90%;">
                <img alt="vehicle" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="<?php echo e($booking->vehicle['image']); ?>">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    <h2 class="text-sm title-font text-gray-500 tracking-widest"><?php echo e($booking->vehicle->user['name']); ?></h2>
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1"><?php echo e($booking->vehicle['name']); ?></h1> <span>
                        <h2 class="text-sm title-font text-gray-500 tracking-widest"><?php echo e($booking->vehicle['brand']); ?></h2>
                    </span>
                    <div class="flex mb-4">
                    ...
                    <div class="flex justify-start">
                        <span style="padding: 3px 8px; border-radius: 10px;background-color:#e6cc00; color: #fff ">status: <?php echo e($booking->status); ?></span>
                    </div>

                    <?php elseif($booking->status=='active'): ?>
                    <div class="flex justify-start">
                        <span style="padding: 3px 8px; border-radius: 10px;background-color:#39b779; color: #fff ">status: <?php echo e($booking->status); ?></span>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <?php elseif($booking->status=='active'): ?>
                        <div class="flex justify-start">
                            <span style="padding: 3px 8px; border-radius: 10px;background-color:#f94449; color: #fff ">payment: <?php echo e($booking->payment); ?></span>
                        </div>
                        ...
                        <?php elseif($booking->payment=='unpaid'): ?>
                        <div class="flex justify-start">
                            <span style="padding: 3px 8px; border-radius: 10px;background-color:#f94449; color: #fff ">payment: <?php echo e($booking->payment); ?></span>
                        </div>
                        ...
                        <?php else: ?>
                        <div class="flex justify-start">
                            <span style="padding: 3px 8px; border-radius: 10px;background-color:#39b779; color: #fff ">payment: <?php echo e($booking->payment); ?></span>
                        </div>
                    ...
                    <div class="flex items-center">
                        <div class="relative">
                            <span style="padding: 3px 8px; border-radius: 10px;background-color:gray; color: #fff; display:flex; justify-content:center; align-items:center; "><ion-icon name="calendar-outline" class="mr-3"></ion-icon><?php echo e($booking->from_date); ?></span>
                        </div>
                        <span class="mx-4 text-gray-500">to</span>
                        <div class="relative">
                            <span style="padding: 3px 8px; border-radius: 10px;background-color:gray; color: #fff; display:flex; justify-content:center; align-items:center; "><ion-icon name="calendar-outline" class="mr-3"></ion-icon><?php echo e($booking->to_date); ?></span>
                        </div>
                    </div>

                    <div class=" relative flex justify-start mt-3">
                        <span style="padding: 3px 8px; border-radius: 10px;background-color:#fff; color:gray; font-size:18px; ">Rs. <?php echo e($booking->price); ?>/day</span>
                    </div>


                    <hr class="mt-4 mb-4">
                    <div style="display: flex; justify-content:start; align-items:center;">
                        <span class="title-font font-medium text-2xl mr-5 text-gray-900">Rs. <?php echo e($booking->total_price); ?></span>
                        <button class="btn px-3 py-2" data-toggle="modal" data-target="#pay-<?php echo e($booking->id); ?>" style="font-size: 17px;">Cash in hand</button>
        ...
        <div class="container">
            ...
            <div class="footer-top">
                ...
                <div class="footer-brand">
                    ...
                    <p class="footer-text">
                        Search for cheap rental cars in Itahari. With a diverse fleet of 1,000 vehicles, AutoMotive offers its
                        consumers an
                ...
                <ul class="footer-list">
                    ...
                    <li>
                        <p class="footer-list-title">Neighborhoods in Itahari</p>
                    </li>
                    ...
                    <li>
                        <a href="#" class="footer-link">Dharan</a>
                    </li>
                    ...
                    <li>
                        <a href="#" class="footer-link">Belbari</a>
                    </li>

                    <li>
                        <a href="#" class="footer-link">Duhabi</a>
                    </li>

                    <li>
                        <a href="#" class="footer-link">Urlabari</a>
                    </li>
  ...
  -->
    ...
    <script>
        var config = {
            ...
            "eventHandler": {
                onSuccess(payload) {
                    ...
                    $.ajax({
                        type : 'POST',
                        url : '/verifypayment/<?php echo e($booking->id); ?>',
                        data:{
                            token : payload.token,
        ...
        btn.onclick = function() {
            ...
            checkout.show({
                amount: `<?php echo e($booking->total_price); ?>` * 100
            });
        }
    </script>
...
</html><?php /**PATH C:\Users\Nishan\Desktop\Automotive\AutoMotive\resources\views/frontend/user/vehicle/payment.blade.php ENDPATH**/ ?>