...
<body>
  ...
  <div class="alert <?php echo e(session('alert') ?? 'alert-danger alert-block'); ?>">
    ...
    <div class="row px-3">
      <div class="col-lg-7 col-xl-5 card flex-row mx-auto px-0">
        ...
        <div class="card-body">
          ...
          <form class="form-box px-3" method="post" action="<?php echo e(route('post.register')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="text-center mb-2">
              ...
              <a href="<?php echo e(route('login')); ?>" class="register-link">
                login
              </a>
            </div>
          </form>
...
</html><?php /**PATH C:\Users\Nishan\Desktop\Automotive\AutoMotive\resources\views/auth/register.blade.php ENDPATH**/ ?>